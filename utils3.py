...
coco_class = ["angular_leafspot","powdery_mildew_fruit","leaf_spot","powdery_mildew_leaf"]
...
def detect_postprocess(prediction, img,img0shape, img1shape, conf_thres=0.25, iou_thres=0.45):
    ...
    for class_id in range(cls_num):
        ...
        for box in temp_boxes:
            ...
            elif mid_w < x_center <= w and  y_center <= mid_h:
            ...
            elif mid_w < x_center <= w and mid_h < y_center :
